...
<html>
  <head> 
    <title>校内首页面</title>
    <link rel="stylesheet" href="/xiaoneinews/css/common.css" type="text/css"/>
  <link rel="stylesheet" href="/xiaoneinews/css/index.css" type="text/css"/>
  ...
  <body>
    ...
    <div class="banner1">
    <img src="/xiaoneinews/images/front/ay-0812-658-280.jpg" style="width: 719px;height: 306px;" />
    </div>
    <div  class="intro">
    ...
    <p>
    校内存知己<br/>
    <input type="image" onclick="" src="/xiaoneinews/images/front/register.jpg" />
    </p>
    </div>
    <!-- 寻找你的朋友 -->
    <div class="sea_friend">
    <span class="font2">寻找你的朋友</span>　<input type="text" name="sea_friend" />
    <img src="/xiaoneinews/images/front/sou.jpg" /><br/>
