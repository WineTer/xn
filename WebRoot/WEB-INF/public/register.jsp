...
<html>
  <head> 
    <title>校内用户注册</title>
    <link rel="stylesheet" type="text/css" href="/xiaoneinews/css/common.css"/>
	<link rel="stylesheet" type="text/css" href="/xiaoneinews/css/register.css"/>
 	<script type="text/javascript" src="/xiaoneinews/js/jquery-1.3.1.js"></script>
 	<script type="text/javascript" src="/xiaoneinews/js/publicJs.js"></script>
 	<script type="text/javascript" src="/xiaoneinews/myAJAX/ajax_uni.js"></script>
  ...
  <body>
   ...
   <!-- 加入校内后，可以选择... -->
   <div class="play_item">
   <img src="/xiaoneinews/images/front/jiaru.jpg" />
   </div>
   <!-- 注册用的表格 -->
   ...
   <img src="/xiaoneinews/images/front/tanhao.png" />如果没有邮箱，请注册<a href="#">Hotmail</a>邮箱。
   </td>
   <td></td>
   </tr>
   <tr>
