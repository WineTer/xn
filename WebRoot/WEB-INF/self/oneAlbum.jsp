...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/xiaoneinews/css/css/updPersonInfo.css" type="text/css"></link>
	</head>
	<body>
				...
				<table width="100%">
					<tr>
												...
												<tr>
													<td rowspan="2" width="10%">
														<a href="profile.do?type=feed&oid=xx"><img
																src="/xiaoneinews/images/userhead/u1.gif" width="50px" height="50px" /> </a>
													</td>
													<td>
											...
											<table width="100%">
												<tr>
													...
													<td width="20%" align="center">
														<a
															href="/xiaoneinews/album.do?flag=onePhotoUI&pid=xx&oid=xx&aid=xx&pageNo=1"
															style="border: 1px #D8DFEA solid;"
															onmouseover="chgImg(this)" onmouseout="chgImg2(this)"
															id="a x"> <img src="/xiaoneinews/images/${loginuser.id }/album/${photo.album.id }/${photo.photo}"
						...
						<td valign="top" align="center">
							<img src="/xiaoneinews/images/front/albumright.jpg" />
						</td>
					</tr>
				</table>
			</div>
