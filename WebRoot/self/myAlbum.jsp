		...
		<div class="album_main">
			<div class="album_left">
					...
					<tr>
						<td colspan="2">
							<table width="100%" border="0" cellspacing="5" cellpadding="5">
								<tr>
									<td rowspan="2" width="10%">
										<a href="profile.do?type=feed&oid=xx"><img
												src="/xiaoneinews/images/userhead/u1.gif" width="50px" height="50px" />
										</a>
									</td>
									<td>
								...
								<tr>
									<td>
										<a href="/xiaoneinews/album.do?flag=addAlbumUI" class="xh">上传新照片</a>
									</td>
								</tr>
							</table>
						</td>
											...
											<tr>
												<td valign="top" width="33%">
													<a href="album.do?type=oneAlbum&oid=xx&pageNo=1&aid=xx">
														<img src="/xiaoneinews/images/photos/c1.jpg" width="200px"
				...
				<div
					...
					<img src="/xiaoneinews/images/front/selfright.jpg" />
				</div>
			</div>
		</div>
		<!-- 引入foot.jsp -->
