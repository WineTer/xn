		...
		<div class="homePage">
			...
			<div class="profile">
				...
				<div class="curInfo">
					...
					<img src="/xiaoneinews/images/front/star.gif" />
					&nbsp;
				...
				<div class="opers">
					<table align="center" border="0" width="100%" cellspacing="1"
						...
						<tr>
							...
							<td class="feedsp" align="center">
								<a href="/xiaoneinews/album.do?flag=myAlbumUI" class="feed">相册</a>
							</td>
							<td class="feedsp" align="center">
							...
							<td>
								<a href="album.do?type=oneAlbum&oid=xx&pageNo=1&aid=xx"
									...
									onmouseout="chgImg2(this)" id="a100"> <img
										src="/xiaoneinews/images/photos/t4.jpg" width="100px" height="75px"
